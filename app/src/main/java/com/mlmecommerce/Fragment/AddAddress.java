...
public class AddAddress extends Fragment {
    ...
    String countryId, countryName, stateId, stateName, cityId, cityName, areaId, areaName, pinCodeId, pinCodeName, addressType="";
    Dialog dialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try{
            ...
            formEditTexts.get(3).setText(MainPage.firstName);
            formEditTexts.get(4).setText(MainPage.mobileNumber);
                                    ...
                                    if (!textViewList.get(3).getText().toString().isEmpty()) {
                                        ...
                                        if (!textViewList.get(4).getText().toString().isEmpty()) {
                                            ...
                                            if (!addressType.equals("")) {
                                                saveAddress(formEditTexts.get(3).getText().toString(), formEditTexts.get(4).getText().toString(), formEditTexts.get(0).getText().toString(), formEditTexts.get(1).getText().toString(), countryId, stateId, cityId, areaId, formEditTexts.get(2).getText().toString(), pinCodeId);
                                            } else {
    ...
    private void saveAddress(String fullName, String mobileNumber, String houseNumber, String buildingName, String countryId, String stateId, String cityId, String areaId, String landMark, String pinCodeId) {
        ...
        String fullAddress="";
        if (landMark.isEmpty()) {
            fullAddress = houseNumber + ", " + buildingName  + ", " + areaName + ", " + cityName + ", " + stateName + " " + pinCodeName+" "+countryName;
        } else {
            fullAddress = houseNumber + ", " + buildingName + ", " + landMark + ", " + areaName + ", " + cityName + ", " +stateName + " " + pinCodeName+" "+countryName;
        }
        ...
        Call<Boolean> call= apiInterface.saveAddress(addressResponse);
        call.enqueue(new Callback<Boolean>() {
            ...
            public void onResponse(Call<Boolean> call, Response<Boolean> response) {
                ...
                if (response.body().booleanValue()==true){
                    pDialog.dismiss();
                    Toasty.normal(getActivity(), "Address Added", Toasty.LENGTH_SHORT).show();
                } else if (response.body().booleanValue()==false){
                    pDialog.dismiss();
                    Toasty.error(getActivity(), "Address Added Failed", Toasty.LENGTH_SHORT, true).show();
                }
            }
