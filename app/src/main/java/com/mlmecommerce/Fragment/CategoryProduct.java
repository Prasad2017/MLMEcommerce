...
public class CategoryProduct extends Fragment {
    ...
    @BindViews({R.id.categoryRecyclerView, R.id.productRecyclerView})
    ...
    public static List<CategoryProductAdapter> instances = new ArrayList();
    public static int viewPagerCurrentPos = 0;
    public static CategoryProductAdapter productAdapter;
    ...
    @OnClick({R.id.sort, R.id.fliter, R.id.cartLayout})
                        ...
                        call.enqueue(new Callback<List<ProductResponse>>() {
                            ...
                            public void onResponse(Call<List<ProductResponse>> call, Response<List<ProductResponse>> response) {
                                ...
                                if (productResponseList == null) {
                                    ...
                                    productAdapter = new CategoryProductAdapter(getActivity(), productResponseList);
                                    CategoryProduct.instances.add(productAdapter);
    ...
    private void getCategoryProductList() {
        ...
        ApiInterface apiInterface = Api.getClient().create(ApiInterface.class);
        Call<List<ProductResponse>> call = apiInterface.getAllCategoryProductList("10", MainPage.userId);
        call.enqueue(new Callback<List<ProductResponse>>() {
            @Override
            public void onResponse(Call<List<ProductResponse>> call, Response<List<ProductResponse>> response) {
