...
import com.mlmecommerce.Fragment.ConfirmOrderDetails;
...
public class OrderCartAdapter extends RecyclerView.Adapter<OrderCartAdapter.MyViewHolder> {
    ...
    Context context;
    public static List<CartResponse> cartResponseList;
    double totalAmount = 0f, amountPayable;
    public static String totalAmountPayable;
    double tax=0f;

    public OrderCartAdapter(Context context, List<CartResponse> cartResponseList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.orde_cart_item_list, null);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (position == cartResponseList.size() - 1) {
            ...
            ConfirmOrderDetails.subAmount.setText(MainPage.currency+" "+totalAmountPayable);
            ConfirmOrderDetails.deliveryAmount.setText(MainPage.currency+" 0");
            ConfirmOrderDetails.totalAmount.setText(MainPage.currency+" "+ totalAmountPayable);
            ConfirmOrderDetails.promoCode.setText("-"+MainPage.currency+" 0");
            ConfirmOrderDetails.orderAmount.setText(MainPage.currency+" "+totalAmountPayable);
                ...
                call.enqueue(new Callback<Boolean>() {
                    ...
                    public void onResponse(Call<Boolean> call, Response<Boolean> response) {
                        ...
                        if (response.body().booleanValue()==true) {
                            ...
                            Config.cartList(context);
                            ((MainPage) context).removeCurrentFragmentAndMoveBack();
                            ((MainPage) context).loadFragment(new ConfirmOrderDetails(), false);
                    ...
                    public void onResponse(Call<Boolean> call, Response<Boolean> response) {
                        try {
                            if (response.body().booleanValue() == true) {
                                ...
                                Config.cartList(context);
                                ((MainPage) context).removeCurrentFragmentAndMoveBack();
                                ((MainPage) context).loadFragment(new ConfirmOrderDetails(), true);
                            } else if (response.body().booleanValue() == false) {
                                progressDialog.dismiss();
                            }
                        }catch (Exception e){
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView productName1, price1, actualPrice1, discountPercentage1, quantity, size, txtGurantee;
        CardView cardView1;
