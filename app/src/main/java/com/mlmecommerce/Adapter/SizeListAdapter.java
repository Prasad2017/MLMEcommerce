...
public class SizeListAdapter extends RecyclerView.Adapter<SizeListAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public SizeListAdapter(Context context, List<SizeWiseProductResponse> sizeWiseProductResponseList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.size.setText(sizeWiseProductResponseList.get(position).getSizeName().trim()+" "+sizeWiseProductResponseList.get(position).getUnitName().trim());
        ...
        holder.size.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProductDetails.sizeProductId = sizeWiseProductResponseList.get(position).getSizeWiseProductId();
